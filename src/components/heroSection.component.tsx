    ...
    return (
        <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden" data-hero-section>
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl">
                <p className="cursor-default text-3xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent transform transition-all duration-1000 ease-out animate-[slideFromLeft_1s_ease-out]">
                    Welcome to, 
                </p>
                <p className="cursor-default text-3xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-200 to-indigo-300 bg-clip-text text-transparent transform transition-all duration-1000 ease-out animate-[slideFromRight_1s_ease-out]">
                    Mike's Space
                </p>
