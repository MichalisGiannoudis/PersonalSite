...
export const TimeLine = () => {
    ...
    return (
        <>
            ...
            <div className="p-8 relative min-h-[1450px] lg:min-h-[800px] overflow-hidden">            
                {visualize && (
                ...
                {!visualize && (
                    <div className="flex lg:justify-center relative">
                        {['idle', 'fading', 'shrinking'].includes(animationStep) && (
                            <div className={`h-335 lg:h-155 w-1 bg-gradient-to-b from-blue-500 to-purple-500 rounded-full ${animationStep === 'shrinking' ? 'animate-shrink-line' : ''}`}></div>
                        )}
